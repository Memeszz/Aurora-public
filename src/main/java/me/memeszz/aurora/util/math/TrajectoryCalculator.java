...
public class TrajectoryCalculator {
    ...
    public static final class FlightPath {
        ...
        public FlightPath(EntityLivingBase entityLivingBase, ThrowingType throwingType) {
            ...
            this.setLocationAndAngles(ipos[0] + ((IRenderManager) Wrapper.getMinecraft().getRenderManager()).getRenderPosX(), ipos[1] + this.shooter.getEyeHeight() + ((IRenderManager) Wrapper.getMinecraft().getRenderManager()).getRenderPosY(), ipos[2] + ((IRenderManager) Wrapper.getMinecraft().getRenderManager()).getRenderPosZ(),
